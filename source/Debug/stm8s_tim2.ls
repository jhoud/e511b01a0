 ...
 541  00d5 c65308        	ld	a,21256
 542  00d8 a4fc          	and	a,#252
 543  00da c75308        	ld	21256,a
 ...
 721  0172 c65308        	ld	a,21256
 722  0175 a4cf          	and	a,#207
 723  0177 c75308        	ld	21256,a
 ...
 901  020f c65309        	ld	a,21257
 902  0212 a4fc          	and	a,#252
 903  0214 c75309        	ld	21257,a
...
2427  05e0 c65305        	ld	a,21253
2428  05e3 a48f          	and	a,#143
2429  05e5 1a01          	or	a,(OFST+1,sp)
2430  05e7 c75305        	ld	21253,a
2431                     ; 520 }
2434  05ea 84            	pop	a
2435  05eb 81            	ret
...
2501  0608 c65306        	ld	a,21254
2502  060b a48f          	and	a,#143
2503  060d 1a01          	or	a,(OFST+1,sp)
2504  060f c75306        	ld	21254,a
2505                     ; 539 }
2508  0612 84            	pop	a
2509  0613 81            	ret
...
2575  0630 c65307        	ld	a,21255
2576  0633 a48f          	and	a,#143
2577  0635 1a01          	or	a,(OFST+1,sp)
2578  0637 c75307        	ld	21255,a
2579                     ; 558 }
2582  063a 84            	pop	a
2583  063b 81            	ret
...
3906  08ed c65305        	ld	a,21253
3907  08f0 a4f3          	and	a,#243
3908  08f2 1a01          	or	a,(OFST+1,sp)
3909  08f4 c75305        	ld	21253,a
3910                     ; 954 }
3913  08f7 84            	pop	a
3914  08f8 81            	ret
...
3984  091c c65306        	ld	a,21254
3985  091f a4f3          	and	a,#243
3986  0921 1a01          	or	a,(OFST+1,sp)
3987  0923 c75306        	ld	21254,a
3988                     ; 974 }
3991  0926 84            	pop	a
3992  0927 81            	ret
...
4062  094b c65307        	ld	a,21255
4063  094e a4f3          	and	a,#243
4064  0950 1a01          	or	a,(OFST+1,sp)
4065  0952 c75307        	ld	21255,a
4066                     ; 994 }
4069  0955 84            	pop	a
4070  0956 81            	ret
...
4783  0a97 43            	cpl	a
4784  0a98 c75302        	ld	21250,a
4785                     ; 1139     TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
4787  0a9b 35ff5303      	mov	21251,#255
4788                     ; 1140 }
4791  0a9f 85            	popw	x
4792  0aa0 81            	ret
...
5074  0b1f 72115308      	bres	21256,#0
...
5084  0b2e c65305        	ld	a,21253
5085  0b31 a40c          	and	a,#12
5086  0b33 1a01          	or	a,(OFST+0,sp)
5087  0b35 c75305        	ld	21253,a
...
5172  0b4f 72195308      	bres	21256,#4
...
5182  0b5e c65306        	ld	a,21254
5183  0b61 a40c          	and	a,#12
5184  0b63 1a01          	or	a,(OFST+0,sp)
5185  0b65 c75306        	ld	21254,a
...
5270  0b7f 72115309      	bres	21257,#0
...
5280  0b8e c65307        	ld	a,21255
5281  0b91 a40c          	and	a,#12
5282  0b93 1a01          	or	a,(OFST+0,sp)
5283  0b95 c75307        	ld	21255,a
...
5363  0000               L702:
5364  0000 66776c69625c  	dc.b	"fwlib\src\stm8s_ti"
5365  0012 6d322e6300    	dc.b	"m2.c",0
5385                     	end
